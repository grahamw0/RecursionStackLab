...
public class PostCalc {
  ...
  /**
   * This is the constructor for class PostCalc.
   * When a PostCalc object is created it will take
   * the input parameter and initialize it to the 
   * expression field.  It will also call the validate() 
   * and compute() methods.  
